    ...
    return (
        <div className="col-xl-3 col-lg-4 col-md-6">
            <div className="gameCard">
                ...
                <a href="#" className={`like ${library.includes(game) ? 'active' : undefined}`}><i class="bi bi-heart-fill" onClick={
                ...
                <a href="#" className='addBag' onClick={()=> handleAddToBag(game)}><i class="bi bi-bag-plus-fill"></i></a>
            </div>
        </div>
    )
}
